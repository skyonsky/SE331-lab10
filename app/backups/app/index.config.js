(function () {
  ...
  angular
    ...
    .config(configFailedRequestRedirect);

  /** @ngInject */
  function configFailedRequestRedirect($locationProvider, $httpProvider) {
    ...
    * unauthenticated requests*/
    ...
    var exampleAppConfig = {
      ...
      * This might be desirable of headers don't work correctly in some
